...
const {
  server,
  mixins: { Io },
  loaders: { AssetsUrl, TypeScriptNg2, Sass, CssInline, HtmlRaw },
    ...
    Io(
      {
        ...
        app: ['webpack-dev-server/client?http://0.0.0.0:3000', 'webpack/hot/only-dev-server', './src/main.browser.ts', './src/critical.css'],
      },
